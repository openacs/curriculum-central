ad_page_contract {
    Page for listing Teaching and Learning Approaches for a specific UoS.
...
if { $edit_p } {
	...
	edit {
	    ...
	    link_url_eval {[export_vars -url -base tl-method-ae { uos_id method_id }]}
	...
	delete {
	    ...
	    link_url_eval {[export_vars -base tl-method-del { uos_id method_id }]}
	...
	-name methods \
	-actions [list "#curriculum-central.add_tl_approach#" [export_vars -base tl-method-ae { uos_id }] "#curriculum-central.add_tl_approach_to_list#"] \
	-multirow methods \
