ad_page_contract {
    Add/Edit a graduate attribute for a specific UoS.
...
ad_form -name gradattr -cancel_url $return_url -form {
    ...
    db_transaction {
	set gradattr_id [package_instantiate_object \
	...
	# Retrieve the latest GA version.
	db_1row latest_ga {}
	# Map the gradattr_id to the latest GA version.
